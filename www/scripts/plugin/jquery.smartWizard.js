...
function SmartWizard(target, options) {
    ...
    var _init = function($this) {
        ...
        if ($this.options.reverseButtonsOrder) {
          if ($this.options.includeNavigationsButton){
      ...
      //$this.target.append(elmActionBar); // AXIOS:
...
// Default Properties and Events
    $.fn.smartWizard.defaults = {
        ...
        includeNavigationsButton: true,   // Add the previous/next button AXIOS:
        showActionBar: true,   // Show action bar AXIOS:
